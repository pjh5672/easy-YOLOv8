...
class TaskAlignedAssigner(nn.Module):
    def __init__(self, topk=13, num_classes=80, bg_idx=-1, alpha=1.0, beta=6.0, eps=1e-9):
        super().__init__()
        self.topk = topk
    ...
    def forward(self, pd_scores, pd_bboxes, anc_points, gt_labels, gt_bboxes, mask_gt):
        ...
        mask_pos, align_metric, overlaps = self.get_pos_mask(pd_scores = pd_scores, 
                                                             pd_bboxes = pd_bboxes, 
                                                             gt_labels = gt_labels, 
                                                             gt_bboxes = gt_bboxes, 
        ...
        # Assigned target
        target_labels, target_bboxes, target_scores = self.get_targets(gt_labels = gt_labels,
                                                                       gt_bboxes = gt_bboxes, 
